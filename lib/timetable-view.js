...
(function (TTV) {
    ...
    function updateCalendarView(icalHref, viewId, today = ICAL.Time.now()) {
        return __awaiter(this, void 0, void 0, function* () {
            const [eventsOList, viewCssLink,] = yield Promise.all([
            ...
            if (icalRes.ok) {
                ...
                try {
                    ...
                    const viewJson = JSON.parse(yield (yield fetch(`./views/${viewId}.json`)).text());
...
window.addEventListener("load", () => __awaiter(void 0, void 0, void 0, function* () {
    const [icalLoadButton, icalUrlInput, eventsDateInput,] = yield Promise.all([
    ...
    icalLoadButton.addEventListener("click", () => __awaiter(void 0, void 0, void 0, function* () {
        if (icalUrlInput.reportValidity() && eventsDateInput.reportValidity()) {
            ...
            yield TTV.updateCalendarView(icalHref, "uts", ICAL.Time.fromJSDate(eventsDateInput.valueAsDate));
        }
    }));
